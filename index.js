...
const PRODUCTS = [
    ...
    },
    {
        ...
        alternatives: [
            { id: "airfryer_ninja", name: "Premium-Alternative: Ninja Foodi Dual Zone" }
        ]
    },
    {
        id: "diffuser",
    ...
    },
    {
        ...
        alternatives: [
            { id: "headphones_budget", name: "Budget-Tipp: Soundcore Life Q30" }
        ]
    },
    {
        id: "waterbottle",
    ...
    },
    {
        ...
        alternatives: [
            { id: "vacuum_budget", name: "Budget-Alternative: Lefant M210" }
        ]
    },
    {
        id: "coffeemaker",
    ...
    },
    {
        ...
        alternatives: [
            { id: "massagegun_budget", name: "Budget-Tipp: Renpho Massagepistole" }
        ]
    },
    {
        id: "chopper",
    ...
    },
{
        ...
        "pros": [
                ...
                "App mit exzellentem Equalizer",
                "60 Stunden Akku"
        ],
        "cons": [
                "Plastik wirkt etwas günstiger",
                "Mikrofonqualität beim Telefonieren nur mittelmäßig"
        ],
        "testDuration": "6 Monate",
        "hypeScore": 5,
        "realityScore": 5,
...
},
{
        ...
        "pros": [
                "Sehr günstig",
                "Sehr flach (passt unter fast jedes Sofa)",
                "Saugt Tierhaare gut ein (keine Bürste, in der sie sich verheddern)"
        ],
        "cons": [
                "Keine Wischfunktion",
                "Keine Laser-Navigation (fährt nach Chaos-Prinzip)"
        ],
        "testDuration": "3 Monate",
        "hypeScore": 3,
        "realityScore": 4,
...
},
{
        ...
        "pros": [
                "Zwei Fächer für unterschiedliche Speisen",
                "SYNC-Funktion beendet beide Fächer zeitgleich",
                "Extrem leistungsstark"
        ],
        "cons": [
                "Nimmt sehr viel Platz auf der Arbeitsplatte ein",
                "Relativ laut"
        ],
...
},
{
        ...
        "pros": [
                "Sehr günstig",
                "USB-C Ladeanschluss (kann mit dem Handy-Ladekabel geladen werden)"
        ],
        "cons": [
                "Nicht so durchdringend stark wie eine Hypervolt",
...
},
{
        ...
        "pros": [
                "Integriertes Kegelmahlwerk spart Platz und Geld",
                "Hochwertige Verarbeitung aus gebürstetem Edelstahl",
                "Milchaufschäumdüse mit richtig Power"
        ],
        "cons": [
                "Benötigt Einarbeitungszeit, bis der Kaffee perfekt läuft",
                "Etwas lauter Mahlvorgang"
        ],
        ...
        "alternatives": [
                {
                        "id": "coffee_delonghi",
                        "name": "Budget-Tipp: De'Longhi Dedica"
                }
        ]
},
{
        ...
        "pros": [
                "Extrem platzsparend (nur 15 cm breit)",
                "Sehr günstiger Einstieg",
                "Schnell aufgeheizt (ca. 40 Sekunden)"
        ],
        "cons": [
                "Kein Mahlwerk integriert (Mühle muss separat gekauft werden)",
                "Mitgelieferte Siebe erzeugen künstliche Crema"
        ],
        "testDuration": "8 Monate",
        "hypeScore": 4,
        "realityScore": 4,
...
},
{
        ...
        "pros": [
                "Kostet oft nur die Hälfte vom Dyson",
                "Knickbares Design macht ihn zum vollwertigen Föhn",
                "Extrem starke Saugkraft beim Locken"
        ],
        "cons": [
                "Kann auf höchster Stufe ziemlich laut sein",
                "Die Aufbewahrungsbox ist riesig"
        ],
        "testDuration": "4 Monate",
        "hypeScore": 5,
        "realityScore": 5,
        ...
        "alternatives": [
                {
                        "id": "beauty_babyliss",
                        "name": "Budget-Tipp: BaByliss Warmluftbürste"
                }
        ]
},
{
        ...
        "pros": [
                ...
                "Macht die Haare extrem glänzend und weich",
                "Bürstenkopf rotiert in beide Richtungen"
        ],
        "cons": [
                "Keine richtigen Locken möglich, nur Volumen und Schwung",
                "Etwas schwerer in der Hand als ein normaler Föhn"
        ],
        "testDuration": "6 Monate",
        "hypeScore": 3,
        "realityScore": 4,
...
},
{
        ...
        "pros": [
                "Rollen zum einfachen Verstauen unterm Sofa",
                "Sehr leiser Motor (stört nicht bei Calls)",
                "Gute Stoßdämpfung"
        ],
        "cons": [
                "Kein Handlauf (darf nur bis max 6 km/h genutzt werden)",
                "App-Anbindung fehlt (aber Fernbedienung ist super)"
        ],
        ...
        "alternatives": [
                {
                        ...
                        "name": "Budget-Tipp: Citysports Laufband"
                }
        ]
},
{
        ...
        "pros": [
                "Sehr günstig",
                "Integriertes Display und Fernbedienung",
                "Relativ leicht"
        ],
        "cons": [
                "Ab 4 km/h spürbar lauter als teurere Modelle",
                "Lauffläche ist etwas schmaler"
        ],
        "testDuration": "3 Monate",
        "hypeScore": 3,
        "realityScore": 3,
...
const translations = {
    de: {
        ...
        search_btn: "Suchen",
        search_suggestions: "Beliebte Suchen: <span>Heißluftfritteuse</span>, <span>Laufband</span>, <span>Espressomaschine</span>",
    ...
    en: {
        ...
        search_btn: "Search",
        search_suggestions: "Popular searches: <span>Airfryer</span>, <span>Walking Pad</span>, <span>Espresso Machine</span>",
