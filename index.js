...
const PRODUCTS = [
    ...
    },
    {
        ...
        rating: 4.7,
        stars: "★★★★★",
        image: "assets/neckpillow.svg",
        amazonLink: "https://www.amazon.de/s?k=Third+of+Life+Nackenstuetzkissen&tag=baokmedia21-21",
        review: "Ein ergonomisches Visco-Schaum-Kissen, das speziell für Seiten- und Rückenschläfer entwickelt wurde. Der viskoelastische Schaum passt sich unter Körperwärme exakt der Nacken- und Kopfkontur an. Belüftungskanäle im Kissen verhindern übermäßiges Schwitzen. Der Bezug ist abnehmbar und waschbar.",
        pros: ["Hervorragende Druckentlastung, hilft spürbar gegen Nackenverspannungen", "Bezug ist thermoregulierend und lässt sich hygienisch waschen", "Visco-Schaum behält auch nach Monaten seine Stützkraft"],
        cons: ["Erfordert 3-5 Tage Eingewöhnungzeit, da es sich anfangs fest anfühlt", "Typischer Memory-Foam-Geruch beim ersten Auspacken verfliegt erst nach 1-2 Tagen"],
        testDuration: "3 Monate",
        hypeScore: 4,
        realityScore: 5,
        hypeComment: "In Schlaf-Foren und Gesundheits-Blogs als Geheimtipp gegen Verspannungen empfohlen.",
        verdict: "Wer morgens oft mit Nackenschmerzen aufwacht, sollte dieses Kissen ausprobieren. Der Stützeffekt ist hervorragend, man muss sich nur kurz an die Form gewöhnen."
    },
    {
        id: "powerbank",
    ...
    },
    {
        ...
        rating: 4.6,
        stars: "★★★★☆",
        image: "assets/bluetoothsender.svg",
        amazonLink: "https://www.amazon.de/s?k=Bluetooth+Transmitter+Receiver&tag=baokmedia21-21",
        review: "Ein 2-in-1 Bluetooth Adapter, der als Sender (TX) oder Empfänger (RX) fungiert. Damit lassen sich alte Fernseher oder Stereoanlagen bluetoothfähig machen, um z.B. Ton an Bluetooth-Kopfhörer zu senden. Umgekehrt empfängt er Musik vom Smartphone und gibt sie über Klinke an alte Autolautsprecher oder HiFi-Anlagen weiter.",
        pros: ["Sehr vielseitig einsetzbar dank Sender- und Empfängermodus", "Keine spürbare Audioverzögerung dank Low-Latency-Unterstützung", "Akku hält bis zu 10 Stunden, kann aber auch permanent am Strom bleiben"],
        cons: ["Das Pairing mit manchen Kopfhörern ohne Display kann anfangs etwas fummelig sein", "Reichweite sinkt bei dicken Wänden spürbar"],
        testDuration: "6 Monate",
        hypeScore: 4,
        realityScore: 4,
        hypeComment: "Ein Problemlöser-Klassiker für alle, die alte Hardware lieben und kabellos hören wollen.",
        verdict: "Ein extrem nützliches und günstiges Gadget. Es rettet alte, teure HiFi-Anlagen vor dem Elektromüll und funktioniert im Alltag nach dem ersten Einrichten tadellos."
    },
    {
        id: "neckmassager",
    ...
    },
    {
        ...
        rating: 4.7,
        stars: "★★★★★",
        image: "assets/resistancebands.svg",
    ...
    },
    {
        ...
        rating: 4.7,
        stars: "★★★★★",
        image: "assets/picnicblanket.svg",
